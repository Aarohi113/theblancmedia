...
export const metadata = {
  title: "PPC Advertising & Paid Media | THEBLANCMEDIA",
  description: "High-ROI paid acquisition campaigns across Google Ads, Meta Ads, and LinkedIn for scalable business growth."
};
    ...
    <div className="pt-28 bg-white">
      ...
      <section className="py-20 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          <SectionHeader
            ...
            title="Data-Driven Ads Built to Scale Revenue, Not Clicks."
            highlightedWord="Revenue, Not Clicks."
      ...
      <section id="capabilities" className="py-20 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <SectionHeader
              badge="Paid Acquisition Channels"
              title="Full-Funnel Media Buying Systems."
              highlightedWord="Media Buying Systems."
            />
          ...
          <div>
            <SectionHeader
              badge="Campaign Deliverables"
              title="Transparent Execution & Reporting."
              highlightedWord="Transparent Execution."
            />
            <div className="mt-8 flex flex-col gap-4">
      ...
      <section className="py-20 sm:py-24 bg-[#F4F4F4] border-t border-neutral-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            title="Our Paid Media Scaling Protocol."
            highlightedWord="Scaling Protocol."
            align="center"
