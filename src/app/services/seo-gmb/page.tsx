...
export const metadata = {
  title: "SEO & Google Business Profile | THEBLANCMEDIA",
  description: "Technical search engine optimization, topical authority frameworks, and Google Business Profile local domination."
};

export default function SEOGMBPage() {
  const service = servicesData.find((s) => s.slug === "seo-gmb")!;
    ...
    <div className="pt-28 bg-white">
      ...
      <section className="py-20 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          <SectionHeader
            ...
            title="Command Organic Search & Dominate Your Market."
            highlightedWord="Dominate Your Market."
      ...
      <section id="capabilities" className="py-20 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <SectionHeader
              badge="Search Capabilities"
              title="Organic & Local Authority Architecture."
              highlightedWord="Authority Architecture."
            />
          ...
          <div>
            <SectionHeader
              badge="SEO Deliverables"
              title="Sustainable Organic Assets Built Monthly."
              highlightedWord="Built Monthly."
            />
            <div className="mt-8 flex flex-col gap-4">
      ...
      <section className="py-20 sm:py-24 bg-[#F4F4F4] border-t border-neutral-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            title="Our Search Ranking System."
            highlightedWord="Ranking System."
            align="center"
