...
export const metadata = {
  title: "Website Development & UI/UX | THEBLANCMEDIA",
  description: "Bespoke Next.js & React digital flagships built for sub-second speed, editorial luxury, and high lead conversions."
};
...
export default function WebDevPage() {
  ...
  return (
    <div className="pt-28 bg-white">
      ...
      <section className="py-20 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          <SectionHeader
            ...
            title="Digital Flagships Built to Elevate Perception and Convert."
            highlightedWord="Elevate Perception"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <SectionHeader
              ...
              highlightedWord="Modern Web Architecture."
            />
          ...
          <div>
            <SectionHeader
              ...
              title="Full Codebase Ownership & Documentation."
              highlightedWord="Codebase Ownership."
            />
            <div className="mt-8 flex flex-col gap-4">
      ...
      {/* 4. Execution Process Workflow */}
      <section className="py-20 sm:py-24 bg-[#F4F4F4] border-t border-neutral-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            badge="Process Workflow"
            title="Our Agile Development Lifecycle."
            highlightedWord="Development Lifecycle."
            align="center"
